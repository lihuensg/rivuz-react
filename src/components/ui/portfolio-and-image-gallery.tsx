...
>(
  (
    ...
    const maxObjectDimension = childSize ? Math.max(childSize.w, childSize.h) : 300;
    const scaleFactor = 1.25;
    const calculatedBuffer = childSize
      ? maxObjectDimension * scaleFactor - childSize.h + 80
      : 150;

    const visibleAreaHeight = childSize
      ? circleDiameter * visibleDecimal + maxObjectDimension / 2 + calculatedBuffer
